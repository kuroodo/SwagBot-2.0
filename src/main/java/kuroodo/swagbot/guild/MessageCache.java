/**CrunchifyMemoryCache code authored and written by App Shah 
 * Source: https://crunchify.com/how-to-create-a-simple-in-memory-cache-in-java-lightweight-cache/
 * 
 * Using this as a placeholder until I make my own. Some modifications have been made.
 */
...
public class MessageCache<K, T> {
	...
	public MessageCache(long crunchifyTimeToLive, final long crunchifyTimerInterval, int maxItems) {
